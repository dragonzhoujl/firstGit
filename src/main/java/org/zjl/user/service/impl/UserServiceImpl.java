package org.zjl.user.service.impl;
...
import org.zjl.base.dao.BaseDaoI;
...
//	@Autowired
	...
	/*	List<Tuser> list = userDao.find("from Tuser t where t.delflag=0 and t.usertype=1 and t.state=0");
	...
	public List<User> list() {
		...
		l = userDao.find("from Tuser t where t.delflag=0  ");
